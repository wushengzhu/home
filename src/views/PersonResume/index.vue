    ...
    <div class="resume-container">
        <div class="resume-left">
            <div class="resume-avatar">
                <CircleItem :src="resume.avatar" :is-show-too-tip="false" class="avatar" />
            ...
            <div class="resume-item">
                ...
                <div class="item-value">
                    <template v-for="item of resume.contact" :key="item.name">
                        <CircleItem :component="iconComponents[item.icon]" :tip-content="item.name" :bg-width="48"
                            :bg-height="48" :iconSize="24" />&nbsp;
                    </template>
                </div>
            </div>
