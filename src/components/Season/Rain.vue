<template>
  <div class="rain-container" ref="rainRef"></div>
</template>
...
function rain(el: HTMLElement = rainRef.value, params?: any) {
  if (!el) {
