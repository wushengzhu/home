<template>
  <div class="cartoon-btn-container">
    <a
      href="#"
      class="button"
      :class="buttonType"
      :style="`--width:${width}px;--height:${height}px;--fontSize:${size}px;`"
    >
      <div class="button__wrapper" @click.stop="clickLook()">
      ...
      <div class="characterBox" v-if="isShowCartoon">
        <div class="character wakeup">
          ...
          <div class="charactor__body" v-if="buttonType === 'bb-btn'"></div>
        </div>
        <div class="character wakeup">
          <div class="character__face"></div>
          <div class="charactor__face2" v-if="buttonType !== 'yb-btn'"></div>
    ...
    <HomeModal ref="modalRef" :width="300" :height="300">
      <div class="game-container">
        <div class="game-content">{{ '让你失望了！' }}</div>
...
.bb-btn .character__face::before,
.bb-btn .character__face::after {
  background: #fff;
}

.bb-btn .charactor__face2 {
  position: absolute;
  z-index: 1;
  top: 8px;
  left: 0;
...
.bb-btn .charactor__face2::before,
.bb-btn .charactor__face2::after {
  content: '';
  position: absolute;
  top: -1px;
  width: 20px;
...
.bb-btn .charactor__body::before,
.bb-btn .charactor__body::after {
  content: '';
  position: absolute;
  top: -4px;
  width: 0;
...
.kb-btn .charactor__face2::before,
.kb-btn .charactor__face2::after {
  content: '';
  position: absolute;
  top: -8px;
  width: 17px;
...
.yb-btn .button__wrapper::before,
.yb-btn .button__wrapper::after {
  content: '';
  position: absolute;
  bottom: 0;
  width: 130px;
...
.bb-btn .button__wrapper::before,
.bb-btn .button__wrapper::after {
  content: '';
  position: absolute;
  width: 80px;
  height: 100px;
...
.kb-btn .button__wrapper::before,
.kb-btn .button__wrapper::after {
  content: '';
  position: absolute;
  width: 110px;
  height: 60px;
...
.bb-btn:hover .wakeup .charactor__face2::before,
.bb-btn:hover .wakeup .charactor__face2::after {
  height: 20px;
}

.bb-btn:hover .wakeup .charactor__body {
  animation: body_hoo_wakeup 0.2s ease;
  animation-fill-mode: forwards;
  border-top: solid 6px #385082;
}

.bb-btn:hover .wakeup .charactor__body::before,
.bb-btn:hover .wakeup .charactor__body::after {
  top: -12px;
  border-top: solid 5px #385082;
}

.kb-btn:hover .wakeup .charactor__face2 {
  animation: face_pen_wakeup 0.2s ease;
  animation-fill-mode: forwards;
}

.kb-btn:hover .wakeup .charactor__face2::before,
.kb-btn:hover .wakeup .charactor__face2::after {
  top: -12px;
  height: 18px;
}
